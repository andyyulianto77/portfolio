...
/**
 * `CustomPortfoliogurudigitalTheme`
 * `CustomPortfoliogurudigitalTheme based on modern flex design system`
 ...
 * @element custom-portfoliogurudigital-theme
 */
class CustomPortfoliogurudigitalTheme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
   ...
   */
  static get tag() {
    return "custom-portfoliogurudigital-theme";
  }
...
customElements.define(CustomPortfoliogurudigitalTheme.tag, CustomPortfoliogurudigitalTheme);
export { CustomPortfoliogurudigitalTheme };
